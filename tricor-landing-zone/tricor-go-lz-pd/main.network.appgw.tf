# locals {
#   application_gateway_name = "appgw-go-eas-pd-shared-01"
# }

# resource "azurerm_application_gateway" "lzappgw-go-pd-eas" {
...
#     public_ip_address_id = azurerm_public_ip.pip-appgw-go-pd-eas.id
#   }
...
# resource "azurerm_public_ip" "pip-appgw-go-pd-eas" {
#   provider            = azurerm.landingzone_go_pd
