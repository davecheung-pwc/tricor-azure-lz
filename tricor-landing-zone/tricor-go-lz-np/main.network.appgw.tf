# locals {
#   application_gateway_name = "appgw-go-eas-np-shared-01"
# }

# resource "azurerm_application_gateway" "lzappgw-go-np-eas" {
...
#     public_ip_address_id = azurerm_public_ip.pip-appgw-go-np-eas.id
#   }
...
# resource "azurerm_public_ip" "pip-appgw-go-np-eas" {
#   provider            = azurerm.landingzone_go_np
